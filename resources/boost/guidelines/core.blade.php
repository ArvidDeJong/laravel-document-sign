...
- Signature data arrives as a `data:image/png;base64,…` URL from the canvas. It must decode strictly to a real PNG of at most 5000 × 5000 pixels and `signature_max_kilobytes` (512); anything else is a validation error on `signature`. The package needs the GD extension.
